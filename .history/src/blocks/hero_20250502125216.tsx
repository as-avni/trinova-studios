...
export default function AboutHeader() {
    return (
        ...
        />
        <Image
            src="/background/landingPagaeMobile.png"
            height={800}
            width={800}
            alt="landing page img"
            priority
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center  gap-8 md:gap-12 px-6">
            ...
            <div className="">
                <h2 className="text-[#0078AA] font-poppins text-lg md:text-2xl pb-0 slide-in-left">Aquastori Softner</h2>
                <h1
                className="text-xl leading-tight md:text-5xl lg:text-4xl pb-4 font-poppins slide-in-left"
