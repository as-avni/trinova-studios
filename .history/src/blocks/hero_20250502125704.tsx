...
export default function AboutHeader() {
    return (
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 px-4 sm:px-6 lg:px-12">
            <div className="flex flex-col items-start space-y-8 fade-in text-left md:text-left lg:mt-12 2xl:mt-[-30%] 2xl:ml-[-40%] w-full">
            <div className="">
                <h2 className="text-[#0078AA] font-poppins text-sm sm:text-lg md:text-2xl pb-0 slide-in-left">Aquastori Softner</h2>
                <h1
                className="text-lg sm:text-xl leading-tight md:text-5xl lg:text-4xl pb-6 font-poppins slide-in-left"
                style={{ animationDelay: "0.1s" }}
                >
                Say Goodbye to Hard Water, Forever!
                </h1>
                <p className="text-sm sm:text-base md:text-xl text-gray-700 slide-in-left pb-6" style={{ animationDelay: "0.2s" }}>
