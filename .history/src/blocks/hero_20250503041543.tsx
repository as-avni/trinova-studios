...
export default function AboutHeader() {
    return (
        <section className="relative bg-[#F5FAFE] bg-[url('/background/hero.png')] bg-cover min-h-screen overflow-visible">
        <Image
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 px-4 sm:px-6 lg:px-12">
            <div className="flex flex-col items-start space-y-6 fade-in text-left 2xl:mt-0 2xl:ml-[-40%] w-full mt-[-10%] md:mt-[-5%] xl:mt-0 ml-5">
            <div className="">
