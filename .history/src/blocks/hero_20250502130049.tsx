...
export default function AboutHeader() {
    return (
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 px-4 sm:px-6 lg:px-12">
            <div className="flex flex-col items-start space-y-6 fade-in text-left md:text-left 2xl:mt-[-30%] 2xl:ml-[-40%] w-full">
            <div className="">
                <h2 className="text-[#0078AA] font-poppins text-sm sm:text-lg md:text-2xl pb-0 slide-in-left">Aquastori Softner</h2>
                <h1
                className="text-lg sm:text-xl leading-tight md:text-5xl lg:text-4xl pb-4 font-poppins slide-in-left"
            ...
            <div className="relative hidden sm:flex gap-0 items-center justify-center">
            <div className="relative z-10 float">
                ...
                width={400}
                height={600}
                className="h-[540px] max-w-full w-[110%] object-cover md:mt-[-30%] md:mr-[20%] md:ml-[-10\0%]"
                priority
                />
            </div>
            </div>
