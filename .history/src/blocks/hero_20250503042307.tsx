...
export default function AboutHeader() {
    return (
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 px-4 sm:px-6 lg:px-12">
            <div className="flex flex-col items-start space-y-6 fade-in text-left 2xl:mt-[-30%] 2xl:ml-[-40%] w-full mt-[-30%] md:mt-[-11%] ml-5">
            <div className="">
                <h2 className="text-[#0078AA] font-semibold text-xl sm:text-lg md:text-2xl pb-0  slide-in-left">Aquastori Softner</h2>
                <h1
                className="text-2xl sm:text-xl 2xl:ml-[20] leading-tight md:text-5xl lg:text-4xl pb-4 font-poppins slide-in-left "
                style={{ animationDelay: "0.1s" }}
                >
                Say Goodbye to Hard Water, Forever!
                </h1>
                <p className="hidden sm:block text-sm sm:text-base md:text-xl text-gray-700 slide-in-left pb-[-10%]" style={{ animationDelay: "0.2s", padding: "1.5px" }}>
                Protect your home, skin, and appliances with the power of pure, <br /> softened water.
                </p>
                <p className="sm:hidden text-sm sm:text-base md:text-xl text-gray-700 slide-in-left pb-[-10%]" style={{ animationDelay: "0.2s" }}>
