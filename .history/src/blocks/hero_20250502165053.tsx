...
export default function AboutHeader() {
    return (
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 px-4 sm:px-6 lg:px-12">
            ...
            <div className="">
                <h2 className="text-[#0078AA] font-poppins font-semibold text-xl sm:text-lg md:text-2xl pb-0 slide-in-left">Aquastori Softner</h2>
                <h1
                ...
                <p className="hidden sm:block text-sm sm:text-base md:text-xl text-gray-700 slide-in-left pb-[-10%]" style={{ animationDelay: "0.2s" }}>
