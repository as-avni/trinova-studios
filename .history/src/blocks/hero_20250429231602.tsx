...
export default function AboutHeader() {
    return (
        ...
        <Image
            ...
            height={800}
            width={800}
            alt="landipriorityhttp://192.168.1.37:3002/_next/image?url=%2Fassets%2Fsoftner.png&w=828&q=75ng page img"
        ...
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center  gap-8 md:gap-12 px-6">
            ...
            <div className="">
                <h2 className="text-[#0078AA] font-poppins text-2xl pb-0 slide-in-left">Aquastori Softner</h2>
                <h1
