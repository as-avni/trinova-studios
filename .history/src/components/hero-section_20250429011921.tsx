    ...
    <section
      ...
      <div className="container mx-auto grid grid-cols-1 gap-8 px-4 md:grid-cols-2 md:gap-12">
        ...
        <div className="relative flex items-center justify-center">
         <div className="absolute inset-0 z-0 flex items-center justify-end text-[12rem] font-bold text-white opacity-80 md:text-[16rem] lg:text-[16rem] overflow-hidden pr-4">
            SOFTENER
          </div>
