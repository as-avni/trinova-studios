...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row md:items-center md:justify-between px-4">
        ...
        <div className="hidden md:flex items-center justify-between w-full md:w-auto space-x-4 md:space-x-8">
          <nav className="flex space-x-8 text-base/6">
            <Link
              href="#home"
