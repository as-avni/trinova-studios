    ...
    <section className="w-full bg-[#f8fbfd] py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mb-12 text-center fade-in">
          ...
          <h1 className="mb-4 text-3xl font-bold md:text-4xl lg:text-5xl">One Solution, Multiple Options</h1>
          <p className="mx-auto max-w-3xl text-gray-700 md:text-lg">
            Browse models by type and take home the perfect water softener for your family.
          </p>
        </div>
