...
export function HeroSection() {
  return (
    <section
      id="home"
      className="w-full bg-[#c6dce7] bg-[url('/background/hero-bg.png')] bg-cover bg-fixed py-16 md:py-24">      
      <div className="container mx-auto grid grid-cols-1 gap-8 px-4 md:grid-cols-2 md:gap-12">
        <div className="flex flex-col justify-center space-y-6 fade-in mt-10">
          <div className="space-y-2">
            ...
            <h1
              className="text-3xl font-bold leading-tight md:text-5xl lg:text-6xl slide-in-left"
        ...
        <div className="absolute inset-0 z-0 flex items-center justify-center text-[12rem] font-bold text-white opacity-70 md:text-[16rem] lg:text-[20rem]">
            SOFTENER
          </div>
