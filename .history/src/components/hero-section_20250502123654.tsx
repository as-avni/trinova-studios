...
export function HeroSection() {
  return (
    <section
      id="home"
      className="w-full bg-cover bg-fixed py-16 md:py-24">      
      <div className="container mx-auto grid grid-cols-1 gap-8 px-4 md:grid-cols-2 md:gap-12">
        <div className="flex flex-col justify-center space-y-6 fade-in mt-10">
          <div className="space-y-2">
            <h2 className="text-[#0078AA] text-base font-medium slide-in-left">Aquastori Softner</h2>
            <h1
              className="text-sm font-bold leading-tight md:text-5xl lg:text-6xl slide-in-left"
              style={{ animationDelay: "0.1s" }}
            >
              Say Goodbye to Hard Water, Forever!
            </h1>
            <p className="mt-4 text-left justify-start text-gray-700 md:text-lg slide-in-left" style={{ animationDelay: "0.2s" }}>
        ...
        <div className="relative flex items-center justify-center md:hidden">
          <div className="relative z-10 float">
            <Image
              src="/assets/softner.png"
              alt="Aquastori Softener Mobile View"
              width={250}
              height={350}
              className="h-auto max-w-full"
              priority
