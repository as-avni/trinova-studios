...
export function Comparison() {
  const features = [
    {
      ...
      aquastori: { value: "", icon: "logo" }, // Aquastori logo
    ...
    },
    {
      ...
      others: { value: "", icon: "star" }, // Different icon for "others"
    },
    {
  ...
  const renderIcon = (icon: string) => {
    switch (icon) {
      ...
      case "logo":
        return <img src="/path-to-logo.png" alt="Aquastori Logo" className="h-8 w-auto" />;
      case "star":
        return <span className="h-5 w-5 text-yellow-400">★</span>; // Example icon
      default:
        return null;
    }
  };
            ...
            <thead>
              <tr>
                ...
                <th className="w-1/3 p-4 text-center">
                  <div className="text-xl font-bold">Aquastori</div>
                </th>
                <th className="w-1/3 p-4 text-center">
            ...
            <tbody>
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <td className="p-4 text-left bg-white">
