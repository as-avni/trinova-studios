    ...
    <section className="relative w-full overflow-hidden bg-[#F5FAFE] py-24 md:py-32">
      ...
      <div className="w-full flex flex-col items-start justify-center md:pl-8 max-w-xl space-y-6">
        ...
        <div className="grid grid-cols-2 gap-2 md:gap-6 ">
          ...
          >
            <h3 className="mb-2 text- md:text-xl font-semibold">Advanced Ion Exchange</h3>
          ...
          >
            <h3 className="mb-2 text- md:text-xl font-semibold">Self-Cleaning System</h3>
          ...
          >
            <h3 className="mb-2 text- md:text-xl font-semibold">Green & Energy Smart</h3>
          ...
          <LinearScrollSection
            ...
            className="rounded-lg bg-white p-6 shadow-md transition-all hover:shadow-lg hover:scale-105 ml-4"
          >
            <h3 className="mb-2 text- md:text-xl font-semibold">Smart Digital Controls</h3>
