      ...
      <div className="w-full flex flex-col items-start justify-center md:pl-8 max-w-xl space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6 ">
          <LinearScrollSection
            ...
            delay={0}
            className="rounded-lg bg-[#0078AA] p-6 text-white transition-all hover:shadow-lg hover:scale-105 mr-0 md:mr-4"
          >
          ...
          <LinearScrollSection
            animationType="fade-in"
            delay={150}
            className="rounded-lg bg-white p-6 shadow-md transition-all hover:shadow-lg hover:scale-105 mr-0 md:mr-4"
          >
          ...
          <LinearScrollSection
            animationType="fade-in"
            delay={300}
            className="rounded-lg bg-white p-6 shadow-md transition-all hover:shadow-lg hover:scale-105 ml-0 md:ml-4"
          >
