...
return (
    ...
    {!isOpen && showPopup && (
    <div className="flex flex-col-reverse items-end gap-2 fixed bottom-5 right-10 z-50">
        <button
    ...
    {isOpen && (
        <div className="bg-white border w-80 rounded-xl shadow-xl flex flex-col overflow-hidden fixed bottom-20 right-10 z-50">
