        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <LinearScrollSection animationType="fade-left" className="space-y-6 my-auto">
            ...
            <p className="text-gray-600 text-lg max-w-lg">
              Aquastori Softner isn&apos;t just a water softener—it&apos;s a game-<br/>changer for your home. Designed with cutting-edge<br/> technology, it delivers the softest water with effortless efficiency.
            </p>
          </LinearScrollSection>
        </div>
