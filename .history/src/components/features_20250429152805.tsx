    ...
    <section className="relative w-full overflow-hidden bg-[#F5FAFE] py-24 md:py-32">
      <div className="container mx-auto px-4 bg-[url('/background/Feature.png')] bg-cover bg-no-repeat bg-center min-h-screen flex flex-col justify-center md:flex-row md:items-center gap-10">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <LinearScrollSection animationType="fade-left" className="space-y-6 my-auto mx-auto">
            <h2 className="text-xl font-medium text-[#0078AA]">Features That Make a Difference</h2>
            <h1 className="text-4xl font-bold md:text-5xl lg:text-4xl leading-tight">Smart. Efficient. Built for <br/>Pure Comfort.</h1>
            <p className="text-gray-600 text-base md:text-lg lg:text-xl max-w-lg">
