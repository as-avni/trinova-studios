      ...
      <div className="container mx-auto px-4">
        <LinearScrollSection animationType="fade-in" className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-3xl text-gray-700 md:text-lg">
            Say goodbye to limescale, dull hair, and costly repairs. Aquastori Softner transforms your water for a
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          >
            ...
            <p className="text-gray-700">
              Hard water causes buildup, damaging pipes. Our softener prevents limescale for a smooth-running home.
            </p>
          </LinearScrollSection>
          ...
          >
            ...
            <p className="text-gray-700">
              Hard water dries skin and brittles hair. Aquastori Softner restores moisture for glowing skin and silky
              hair.
            </p>
          </LinearScrollSection>
