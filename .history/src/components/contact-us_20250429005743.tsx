    ...
    <section id="contact" className="w-full bg-[#f8fbfd] py-16 md:py-24">
      <div className="container mx-auo px-4">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
          ...
          <div className="fade-in justify-center mx-auto" style={{ animationDelay: "0.2s" }}>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full rounded-xl border border-gray-400 p-3 transition-all focus:border-[#0078AA] focus:outline-none focus:ring-1 focus:ring-[#0078AA] hover:border-[#0078AA]/50"
                  required
                />
              </div>
              <div>
