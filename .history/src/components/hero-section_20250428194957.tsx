...
export function HeroSection() {
  return (
    <section
      ...
      <div id="text" className="relative container mx-auto grid grid-cols-1 gap-8 px-4 md:grid-cols-2 md:gap-12">
        <div className="absolute inset-0 flex justify-center items-center pointer-events-none">
          <h1 className="text-white text-[10rem] md:text-[14rem] font-extrabold opacity-10 z-10 leading-none">
            SOFTENER
          </h1>
        </div>

        <div className="flex flex-col justify-center space-y-6 fade-in mt-10 relative z-10">
