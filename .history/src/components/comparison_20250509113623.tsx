...
export function Comparison() {
  ...
  return (
    <section className="w-full bg-[#F5FAFE] py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mb-12 text-center fade-in">
          <h2 className="mb-2 text-xl font-medium text-[#0078AA]">Compare the Difference</h2>
          <h1 className="mb-4 text-2xl font-semibold font-nexa md:text-3xl lg:text-4xl">
            Aquastori vs. The Rest – What Sets <span className="hidden md:inline"><br/></span>Us Apart
          </h1>
        ...
        <div className="mx-auto max-w-4xl overflow-x-auto fade-in">
          <table className="w-full border-collapse">
            <thead>
              <tr>
                <th className="w-1/3 p-2 md:p-4 text-left"></th>
                <th className="w-1/3 p-2 md:p-4 text-center bg-white rounded-tl-xl rounded-tr-xl">
                    <Image src="/assets/aquastori-logo.png" alt="Aquastori Logo" width={150} height={50} className="mx-auto" />
                </th>
                <th className="w-1/3 p-2 md:p-4 text-center">
            ...
            <tbody> 
              {features.map((feature, index) => (
                <tr key={index} className="border-t border-gray-200 transition-colors hover:bg-gray-50">
                  <td className="p-2 md:p-4 text-left font-medium">{feature.name}</td>
                  <td className="p-2 md:p-4  text-center bg-white ">
