    ...
    <section className="relative w-full overflow-hidden bg-[#F5FAFE] py-24 md:py-32">
      ...
      <div className="w-full flex flex-col items-start justify-center md:pl-8 max-w-xl space-y-6">
          <LinearScrollSection animationType="fade-left" className="space-y-4">
            ...
            <p className="text-gray-600 text-sm md:text-lg font-extrabold md:font-semibold leading-relaxed mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-6 ">
          <LinearScrollSection
            ...
            delay={0}
            className="rounded-lg bg-[#0078AA] p-6 text-white transition-all hover:shadow-lg hover:scale-105 mx-auto mr-0 md:mr-4"
          >
