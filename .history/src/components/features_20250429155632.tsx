...
export function Features() {
  return (
    <section className="relative w-full overflow-hidden bg-[#F5FAFE] py-24 md:py-32">
      <div className="container mx-auto px-4 bg-[url('/background/Feature.png')] bg-cover bg-no-repeat bg-center min-h-screen flex flex-col justify-center md:flex-row md:items-center gap-1">
        <div className="grid grid-cols-1 md:grid-cols-2">
          <LinearScrollSection animationType="fade-left" className="space-y-6 my-auto">
            ...
            <h1 className="text-3xl font-semibold ">Smart. Efficient. Built for <br/>Pure Comfort.</h1>
            <p className="text-gray-600 text-lg">
              Aquastori Softner isn&apos;t just a water softener—it&apos;s a game-<br/>changer for your home. Designed with cutting-edge<br/> technology, it delivers the softest water with effortless<br/> efficiency.
            </p>
          </LinearScrollSection>
        </div>

        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2 lg:grid-rows-2">
          <LinearScrollSection
            animationType="fade-in"
            delay={0}
            className="rounded-lg bg-[#0078AA] p-6 text-white transition-all hover:shadow-lg hover:scale-105 mr-4"
          >
          ...
          <LinearScrollSection
            animationType="fade-in"
            delay={150}
            className="rounded-lg bg-white p-6 shadow-md transition-all hover:shadow-lg hover:scale-105 mr-4"
          >
          ...
          <LinearScrollSection
            animationType="fade-in"
            delay={300}
            className="rounded-lg bg-white p-6 shadow-md transition-all hover:shadow-lg hover:scale-105 ml-4"
          >
