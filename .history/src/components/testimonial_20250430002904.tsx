    ...
    <section id="testimonial" className="w-full bg-[#F5FAFE] py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mb-32 text-center">
          ...
          <h1 className="mb-4 text-3xl font-semibold md:text-4xl lg:text-5xl">What Our Customers Are Saying</h1>
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          >
            <ChevronLeft className="h-2 md:h-6 w-2 md:w-6" />
          </button>
          ...
          <div className="flex items-center justify-center space-x-8 transition-all duration-700 ease-in-out">
            {getVisibleTestimonials().map((testimonial, index) => {
              ...
              return (
                <div
                  key={testimonial.id}
                  className={`flex w-80 h-72 flex-col items-center justify-start rounded-lg bg-white p-6 text-center transition-all duration-700 ${
