...
export function Features() {
  return (
    <section className="relative w-full overflow-hidden bg-[#f8fbfd] py-16 md:py-24">
      <div className="container mx-auto px-4 bg-[url('/background/Feature.png')] bg-cover h-scren my-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-">
