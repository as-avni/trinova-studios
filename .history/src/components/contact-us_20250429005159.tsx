            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  className="w-[80%]  rounded-md border border-gray-200 p-3 transition-all focus:border-[#0078AA] focus:outline-none focus:ring-1 focus:ring-[#0078AA] hover:border-[#0078AA]/50"
                  required
                />
              </div>
              <div>
