        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 ">
          <div className="overflow-hidden rounded-lg transition-all hover:shadow-xl hover:scale-105">
            <div className="relative h-[100%] w-full">
              ...
              />
              <div className="absolute bottom-0 mx-auto left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6 text-white">
                <h3 className="mb-2 text-xl font-semibold">Gentle on Skin</h3>
                <p className="text-sm">Soft water that&apos;s safe and soothing, even<br/> for the little ones.</p>
              </div>
            </div>
          </div>
          ...
          <div className="overflow-hidden rounded-lg transition-all hover:shadow-xl hover:scale-105">
            <div className="relative h-96 w-full">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6 text-white">
                ...
                <p className="text-sm">No stains, no spots, just naturally clean<br/> dishes and surfaces.</p>
              </div>
            </div>
          </div>
