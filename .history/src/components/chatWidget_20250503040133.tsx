...
return (
    ...
    {!isOpen && (
      <div className="relative flex flex-col items-end gap-2">
        <div className="bg-blue-600 text-white p-3 rounded-xl w-72 shadow-xl">
          <div className="flex justify-between items-start gap-2">
            <div className="flex gap-2">
              <span className="text-white text-lg">🤖</span>
              <div>
                <strong>Aquastori Softner</strong>
                <p className="text-sm">Hi 👋 have a look around & let us know if you have any question</p>
              </div>
            </div>
            <X size={16} className="cursor-pointer" onClick={() => setIsOpen(true)} />
          </div>
        </div>
