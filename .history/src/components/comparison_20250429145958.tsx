          ...
          <table className="w-full border-collapse">
            <thead>
              <tr>
                ...
                <th className="w-1/3 p-4 text-center bg-white rounded-tl-xl rounded-tr-xl">
                    <Image src="/assets/aquastori-logo.png" alt="Aquastori Logo" width={150} height={50} className="h-8 w-auto mx-auto" />
                </th>
