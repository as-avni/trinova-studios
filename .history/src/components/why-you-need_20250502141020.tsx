...
export function WhyYouNeed() {
  return (
    <section id="benefits" className="w-full bg-[#F5FAFE] py-16 md:py-24 font-poppins">
      <div className="container mx-auto px-4">
        <LinearScrollSection animationType="fade-in" className="mb-12 text-center">
          ...
          <h1 className="mb-4 text-22xl md:text-4xl lg:text-5xl">Hard Water? We&apos;ve Got the Fix!</h1>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          >
            ...
            <h3 className="text-xl">Say Goodbye to Clogs & Stains</h3>
          ...
          >
            ...
            <h3 className="text-xl">Every Shower, a Fresh Start</h3>
            <p className="text-gray-700">
              Hard water dries skin and brittles hair.<br/> Aquastori Softner restores moisture for<br/> glowing skin and silky
              hair.
            </p>
          </LinearScrollSection>
          ...
          >
            ...
            <h3 className="text-xl">Make Appliances Last Longer</h3>
            <p className="text-gray-700">
              Hard water wears down appliances. Our <br/>system prevents damage, boosting<br/> efficiency and cutting repair
              costs.
            </p>
          </LinearScrollSection>
        </div>
