  ...
  <div className="fixed bottom-5 right-5 z-50 font-sans w-full max-w-sm rounded-3xl overflow-hidden shadow-xl">
    ...
    {isOpen && (
      <div className="w-full flex flex-col overflow-hidden">
        {/* Header */}
        <div className="text-white p-4 flex items-center justify-between bg-opacity-0">
        ...
        <div className="bg-white p-4 h-64 overflow-y-auto">
          {messages.map((msg, i) => (
            ...
            >
              ...
              <div
                className={`p-3 rounded-2xl backdrop-blur bg-white/20 ${
                  msg.from === "bot" ? "text-gray-800" : "text-black"
                }`}
              >
                <p>{msg.text}</p>
              </div>
          ...
          <div className="flex items-center gap-2">
            <div className="relative flex-1">
              <input
                ...
                className="w-full py-3 px-4 bg-transparent border border-gray-300 rounded-full outline-none"
                value={input}
