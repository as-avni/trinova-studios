...
return (
    ...
    <div className="relative flex flex-col items-end gap-2">
        <div className="bg-blue-600 text-white px-4 py-3 rounded-2xl w-80 shadow-xl flex items-start gap-3">
          ...
          <div className="flex-1">
            <div className="flex justify-between items-start">
              ...
              <X size={18} className="cursor-pointer" onClick={() => setIsOpen(true)} />
            </div>
