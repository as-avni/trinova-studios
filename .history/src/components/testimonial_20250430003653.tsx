          ...
          <div className="flex items-center justify-center space-x-8 transition-all duration-700 ease-in-out">
            {getVisibleTestimonials().map((testimonial, index) => {
              ...
              return (
                <div
                  key={testimonial.id}
                  className={`flex w-80 h-80 md:h-72 md:flex-col flex-col-reverse items-center justify-start rounded-lg bg-white p-6 text-center transition-all duration-700 ${
