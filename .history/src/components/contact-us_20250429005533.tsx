            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 p-3 transition-all focus:border-[#0078AA] focus:outline-none focus:ring-1 focus:ring-[#0078AA] hover:border-[#0078AA]/50"
                  required
                />
              </div>
              <div>
              ...
              <div>
                <button
                  type="submit"
                  className="rounded-lg bg-[#FF7A45] px-8 py-3 text-white transition-all hover:bg-[#FF7A45]/90 hover:shadow-md hover:translate-y-[-2px]"
                >
                  Submit
                </button>
              </div>
