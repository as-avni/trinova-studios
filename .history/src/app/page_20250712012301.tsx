...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Coming Soon Section */}
      <section className="py-12 md:py-16 bg-[#77249c]">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-0">
            <div className="fade-in order-2 lg:order-1" ref={el => { fadeRefs.current[2] = el }}>
              <iframe
                ...
                className="w-full h-64 md:h-80 rounded-lg shadow-2xl mb-0"
                allow="autoplay; fullscreen"
              ></iframe>
            </div>
            <div
            ...
            >
              <h2 className="coming-soon-text text-4xl sm:text-5xl md:text-6xl mb-8 text-white font-smoochsans ml-[-35%]">COMING SOON</h2>
              <div className="flex justify-center lg:justify-start mb-8">
                <Image
                  ...
                  width={450}
                  height={175}
                  className="max-w-full h-full mt-[-10%] md:mt-[-5%] lg:mt-0 mb-0"
                />
              </div>
            </div>
          </div>
