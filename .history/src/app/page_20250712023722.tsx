...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Coming Soon Section */}
      <section className="py-4 md:py-8 bg-[#77249c]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-0">
            ...
            >
              <h2 className="coming-soon-text text-4xl sm:text-5xl md:text-7xl mb-2 text-white font-smoochsans ml-[-40%]">COMING SOON</h2>
              <div className="flex justify-center lg:justify-start mb-8">
                <Image
                  ...
                  width={450}
                  height={175}
                  className="max-w-full h-full mt-0 mb-0"
                />
              </div>
            </div>
          </div>
